...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MimicWebApi.DAL.Models.Character", b =>
                {
            ...
            modelBuilder.Entity("MimicWebApi.DAL.Models.Item", b =>
                {
            ...
            modelBuilder.Entity("MimicWebApi.DAL.Models.Properties", b =>
                {
            ...
            modelBuilder.Entity("MimicWebApi.DAL.Models.Room", b =>
                {
                    b.Property<int>("RoomId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MimicWebApi.DAL.Models.RoomStorageRelation", b =>
                {
            ...
            modelBuilder.Entity("MimicWebApi.DAL.Models.Storage", b =>
                {
                    b.Property<int>("StorageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MimicWebApi.DAL.Models.User", b =>
                {
            ...
            modelBuilder.Entity("MimicWebApi.DAL.Models.Character", b =>
                {
                    b.HasOne("MimicWebApi.DAL.Models.User", "Creator")
                        .WithMany("Characters")
                        .HasForeignKey("CreatorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MimicWebApi.DAL.Models.Room", "Room")
                        .WithMany("Characters")
            ...
            modelBuilder.Entity("MimicWebApi.DAL.Models.Item", b =>
                {
                    ...
                    b.HasOne("MimicWebApi.DAL.Models.Storage", "Storage")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("MimicWebApi.DAL.Models.Properties", b =>
                {
                    b.HasOne("MimicWebApi.DAL.Models.Item", null)
                        .WithMany("Properties")
            ...
            modelBuilder.Entity("MimicWebApi.DAL.Models.Room", b =>
                {
                    b.HasOne("MimicWebApi.DAL.Models.User", "Master")
                        .WithMany("Rooms")
