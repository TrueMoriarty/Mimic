...
using MimicWebApi.DataLayer.Models;

namespace MimicWebApi.DataLayer.EfCode;
...
public class MimicContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) => optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=Mimicdb;Username=pgadmin;Password=pgadmin");
